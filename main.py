...
# wifi.wait()
# while True:
#     t = requests.get("http://192.168.179.1:8186/trustme.lua?accept=")
#     print("Trust me HTTP request status Code:",t.status_code)
#     #print(r.status_code)
...
# print(temp)
# width = display.getTextWidth(temp,"Roboto_Regular18")
# widthHalf = int(width/2)
# print("text width:",width)

# display.drawFill(0xffffff) # Fill the screen with black
# display.drawPng(0,0,"/lib/luxPublicTransport/busBoardV2.png")
# display.drawText(106-widthHalf, 10, temp, 0xFFFFFF, "Roboto_Regular18")
# display.drawCircle(120, 12, 2,0,360,True,0xffffff)
# display.drawCircle(120, 12, 1,0,360,True,0x000000)

# for x in range (0,4):
#     display.drawRect(0, 45+(x)*65, 128, 55,True,  0x000000)
#     display.flush()